...
**交叉硬门（Build 窜入）：** 若当前会话只批准了 Build /「开始做」/「确认方案」、且本轮未明示「部署 / 上线 / 发布」，**禁止 P5**。缺 P2/P3（L1/L2）或未获本轮 P4 → 停并摘要，不执行生产命令。  
**交叉硬门（验收闸）：** 许愿路径下 Spec 仍为 `awaiting-human-acceptance`、或无人明示通过/关版时，**禁止**进入生产 P5（人明文豁免并担责除外）。
