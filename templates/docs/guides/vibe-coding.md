...
这张表由技术管理员补全。PM 首次使用时，Agent 只报告“可开始”或缺失项及其负责人，不让
PM 猜命令、账号或环境事实。
...
4. Build / Repair 以当前 Spec（`technical-plan.md` + `spec-run.md`）为准；
5. 按 Spec 的 Workspace Strategy 选择 Local 或 Worktree。
