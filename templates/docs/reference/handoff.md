...
| Spec | Spec Run 状态 | 当前模式 | Owner | Workspace | Branch | PR | 恢复指针 | Claims | Dependencies | Shared Resource | Next | Blocker |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| | | | | | | | | | | | | |
...
| 事项 | Spec | 所需动作 | Owner | 登记日期 |
|---|---|---|---|---|
| | | | | |

## 最近关闭

| Spec | 结果 | Delivery Target | Workspace / PR | 关闭日 |
|---|---|---|---|---|
| | | | | |
